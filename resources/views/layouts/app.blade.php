...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <body class="font-sans antialiased">
    ...
    <div class="min-h-screen bg-gray-200">
      <x-gui.navigation-menu />
      {{-- @livewire('navigation-menu') --}}

      <main class="py-20">

        @if (isset($errors) and $errors->any())
          <div id="alert-error" class="p-4 mb-4 text-red-800 bg-red-100 rounded-lg dark:bg-gray-800 dark:text-blue-400" role="alert">
        ...
        @if (session()->has('success'))
          <div id="alert-success" class="flex p-4 mb-4 text-green-800 bg-green-100 rounded-lg dark:bg-gray-800 dark:text-green-400" role="alert">
